...
const jsonFilePath = 'C:/Users/User/Desktop/Blockjson.json';
...
it('Put api test to the block allocation', async function ({ supertest }) {
   ...
   // Get reservation Grs
    it('GET Reservation  GRS', async function ({ supertest }) {
      ...
      after(function () {
        const excelFilePath = path.join("C:/Users/User/Documents/QA-Automation/tests/step_definitions/api/excel.xlsx");
