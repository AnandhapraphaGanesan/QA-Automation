...
describe('api Authu Token', function () {
  ...
  it('Get api test after login', async function ({ supertest }) {
    await supertest
      .request("https://ihgcu2ua.hospitality-api.us-ashburn-1.ocs.oc-test.com")
      .get("/rsv/v1/hotels/GRVZA/reservations/85586")
      .set('Content-Type', 'application/json')
      .set('x-hotelid', 'GRVZA')
      .set('x-app-key', '69594b78-9894-4914-a894-860ca6d056db')
      .set('bypass-routing', 'N')
      ...
      // const confirmationType = responseBody.confirmationType; // Adjust according to the actual response structure
      //  confirmationId = confirmationType ? confirmationType.id : null;
  
      // if (confirmationId) {
      //     console.log("Confirmation ID:", confirmationId);
      // } else {
      //     console.error("Confirmation ID not found");
      // }
  
      // const locationHeader = response.headers['location'];
      // const urlParts = locationHeader.split('/');
      // campaignId2 = urlParts[urlParts.length - 1];
      // console.log("Campaign ID: ", campaignId2);
      // await supertest
      // .then(function (response) {
      //   console.log(response)
...
it('post api test after login', async function ({ supertest }) {
  console.log(campaignId,'288');
  await supertest
    .request("https://ihgcu2ua.hospitality-api.us-ashburn-1.ocs.oc-test.com")
    .post("/rsv/v1/hotels/GRVZA/reservations/"+"85586"+"/copy")
    .set('Content-Type', 'application/json')
    .set('x-hotelid', 'GRVZA')
    .set('x-app-key', '69594b78-9894-4914-a894-860ca6d056db')
    .set('bypass-routing', 'N')
