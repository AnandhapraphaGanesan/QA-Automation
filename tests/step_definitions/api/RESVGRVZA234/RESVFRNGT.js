...
const filePath = "C:/Users/Admin/Desktop/resultsone.xlsx";
...
data.forEach(row => {
    let authToken1, authToken2, reservationId, confirmationId, externalReferenceId;
    ...
    describe('API Auth Token', function () {
        ...
        it('GET AuthToken1', async function ({ supertest }) {
            await supertest
                ...
                .set('Content-Type', row['Content-Type'])
