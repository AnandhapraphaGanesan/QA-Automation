...
it("GET Reservation GRS", async function ({ supertest }) {
    ...
    it("GET Copy Reservation GRS", async function ({ supertest }) {
        ...
        after(function () {
            ...
            const sheetName = 'flow6';  // Change this for each program (e.g., 'Program1', 'Program2', etc.)
         
            // Use an object to map sheet names to their corresponding headers
            const headersMap = {
                'flow6': ['Reservation ID', 'Confirmation ID', 'External Reference ID', 'IHG Confirmation Number', 'External Confirmation Number', 'PMS Confirmation Number', 'CancellationId1', 'CancellationStatus1'],
