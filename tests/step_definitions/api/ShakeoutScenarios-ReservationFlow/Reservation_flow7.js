        ...
        await supertest
            ...
            .then(function (response) {
               //console.log(response)
                ...
                excelData.push([reservationIds, confirmationId,externalReferenceId,ihgConfirmationNumber,externalConfirmationNumber,pmsConfirmationNumber]);
            });
   });
   after(function () {
    ...
    const sheetName = 'flow7';  // Change this for each program (e.g., 'Program1', 'Program2', etc.)
 
    // Use an object to map sheet names to their corresponding headers
    const headersMap = {
        'flow7': ['Reservation ID', 'Confirmation ID', 'External Reference ID', 'IHG Confirmation Number', 'External Confirmation Number', 'PMS Confirmation Number', 'CancellationId1', 'CancellationStatus1'],
