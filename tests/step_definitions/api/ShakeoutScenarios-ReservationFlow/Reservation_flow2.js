...
it('PUT Reinstate Reservation', async function({supertest}) {
    ...
    it('GET Reservation GRS', async function ({ supertest }) {
        await supertest
            ...
            .then(function (response) {
                ...
                excelData.push([reservationId, confirmationId,externalReferenceId,ihgConfirmationNumber,externalConfirmationNumber,pmsConfirmationNumber,pmsStatus1]);
            })
    });
    ...
    after(function () {
        ...
        const sheetName = 'flow2';  // Change this for each program (e.g., 'Program1', 'Program2', etc.)
     
        // Use an object to map sheet names to their corresponding headers
        const headersMap = {
            'flow2': ['Reservation ID', 'Confirmation ID', 'External Reference ID', 'IHG Confirmation Number', 'External Confirmation Number', 'PMS Confirmation Number', 'PMS Status'],
