    ...
    it('PUT Check Validation', async function ({ supertest }) {
        ...
        it('GET Reservation GRS', async function ({ supertest }) {
            ...
            after(function () {
              ...
              const sheetName = 'flow5';  // Change this for each program (e.g., 'Program1', 'Program2', etc.)
           
              // Use an object to map sheet names to their corresponding headers
              const headersMap = {
                  'flow5': ['Reservation ID', 'Confirmation ID', 'External Reference ID', 'IHG Confirmation Number', 'External Confirmation Number', 'PMS Confirmation Number', 'CancellationId1', 'CancellationStatus1'],
