...
it('GET Reservation GRS', async function ({ supertest }) {
 ...
 it('PUT Reinstate Reservation', async function({supertest}) {
    ...
    after(function () {
        ...
        const sheetName = 'flow3';  // Change this for each program (e.g., 'Program1', 'Program2', etc.)
     
        // Use an object to map sheet names to their corresponding headers
        const headersMap = {
            'flow3': ['Reservation ID', 'Confirmation ID', 'External Reference ID', 'IHG Confirmation Number', 'External Confirmation Number', 'PMS Confirmation Number', 'PMS Status'],
