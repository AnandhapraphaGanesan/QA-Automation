...
// Create a new worksheet for 'NewData' and append the fake data
const newDataSheet = XLSX.utils.json_to_sheet(fakeDataJson);
XLSX.utils.book_append_sheet(loadedWorkbook, newDataSheet, 'NewData');

// Write the updated workbook to the file
XLSX.writeFile(loadedWorkbook, filePath);

console.log(`Data has been imported from 'FakeData' to 'NewData' in ${filePath}`);
