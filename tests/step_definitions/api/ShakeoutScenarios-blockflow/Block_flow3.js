      ...
      .send(
        {
          "blocks": {
            "blockInfo": {
              "block": {
                "blockDetails": {
                  "blockCode": reservation.blockcode3,
                  "blockName": "Valid",
                  "timeSpan": {
    ...
    .send(
      {
        "blockAllocationRange": {
          ...
          "beginDate": reservation.arrivalDate1,
          "endDate": reservation.arrivalDate1,
...
it('put api test Cancel the group block', async function({supertest}) {
    ...
    it(`Post API Test for check block availability`, async function({ supertest }) {
      ...
      "arrivalDate": reservation.arrivalDate1,
    }
        )
           .set('x-hotelid', reservation.hotelId)
           .set('x-app-key', reservation['x-app-key'])
                    ...
                    "hotelReservation": {
                      ...
                      "roomStay": {
                        "roomRates": {
                          ...
                          "numberOfUnits": "1",
                          "start":reservation.arrivalDate1,
                          "end": reservation.departureDate1
                        },
                        "guestCounts": {
                          "adults": "1",
                          "children": "0"
                        ...
                        "expectedTimes": {
                          "reservationExpectedArrivalTime": reservation.arrivalDate1,
                          "reservationExpectedDepartureTime": reservation.departureDate1
                        },
                        "guarantee": {
                          "guaranteeCode": "GC"
                        },
                        "arrivalDate": reservation.arrivalDate1,
                        "departureDate": reservation.departureDate1
                      },
                      "reservationGuests": {
                        "profileInfo": {
                          "profile": {
      ...
      after(function () {
        ...
        const sheetName = 'Block Flow3';  // Change this for each program (e.g., 'Program1', 'Program2', etc.)
      
        // Use an object to map sheet names to their corresponding headers
        const headersMap = {
            'Block Flow3': ['BlockID', 'Reservation ID', 'Confirmation ID', 'External Reference ID', 'IHG Confirmation Number', 'External Confirmation Number', 'PMS Confirmation Number'],
